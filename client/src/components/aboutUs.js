...
export default function aboutUs() {
  return (
    ...
    //         About The Team
    //     </div>
    //     <div id="cardsGrid" class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 place-items-center pt-5">
    ...
    <>
        <div class="bg-gray-200 h-fit pb-40">
            {/* <div class="container">
                <img id="uml" class=" h-[55vh] w-full flex items-center mb-[-8vh]" src={uml}>
                </img> violet-600
            </div> */}
